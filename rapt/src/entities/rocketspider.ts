...
class RocketSpider extends SpawningEnemy {
    leftChasesA = true;
    leftSpawnPoint = new Vector(0, 0);
    rightSpawnPoint = new Vector(0, 0);
    timeSinceStart = 0;
    legs: RocketSpiderLegs;
    sprites: Sprite[];
    animationDelay = 0;
    animationIsOnFloor = false;//0;
    constructor(center, angle) {
        ...
        this.animationIsOnFloor = false;//0;
    }
