...
function drawCogIcon(c: CanvasRenderingContext2D, x: number, y: number, time: number) {
    c.save();
...
function drawGoldenCog(c: CanvasRenderingContext2D, x: number, y: number, time: number) {
    c.save();
    c.strokeStyle = 'rgb(255, 245, 0)';
    c.fillStyle = 'rgb(255, 245, 0)';
